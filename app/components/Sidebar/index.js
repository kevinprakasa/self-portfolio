    ...
    return (
      	<StyledSidebar>
      		<div className="bar">
      			...
      			<div className="navItem">
      				<span><img className="navlogo" src={Experience}/></span><a href="#"> Experience</a>
      			</div>
      			<div className="navItem">
      				<span><img className="navlogo" src={Projects}/></span><a href="#">Projects</a>
      			</div>
      			<div className="navItem">
      				<span><img className="navlogo" src={Education}/></span><a href="#">Education</a>
      			</div>
      			<div className="navItem">
      			...
      			<div className="navItem">
      				<span><img className="navlogo" src={Experience}/></span><a href="#">Blog</a>
      			</div>
      		</div>
      	</StyledSidebar>
    );
